...
const leaveData = {
  summary: [
    { month: '2025-01', leavesAdded: 2, leavesTaken: 0, balanceTillMonth: 2 },
    { month: '2025-02', leavesAdded: 2, leavesTaken: 1, balanceTillMonth: 3 },
    { month: '2025-03', leavesAdded: 2, leavesTaken: 2, balanceTillMonth: 3 },
    { month: '2025-04', leavesAdded: 2, leavesTaken: 9, balanceTillMonth: -4 },
    { month: '2025-05', leavesAdded: 2, leavesTaken: 0, balanceTillMonth: -2 },
    { month: '2025-06', leavesAdded: 2, leavesTaken: 6, balanceTillMonth: -6 }
  ],
  totalEntitled: 12,
  totalTaken: 18,
  balance: -6
...
const LeaveBalanceScreen = () => {
  const renderItem = ({ item }) => (
    <View style={styles.card}>
      <Text style={styles.month}>{moment(item.month).format('MMMM YYYY')}</Text>
      <Text>Leaves Added: {item.leavesAdded}</Text>
      <Text>Leaves Taken: {item.leavesTaken}</Text>
      <Text style={[styles.balance, { color: item.balanceTillMonth < 0 ? 'red' : 'green' }]}>
        Balance Till Month: {item.balanceTillMonth}
      </Text>
    </View>
  );
  ...
  const renderFooter = () => (
    <View style={styles.footer}>
      <Text style={styles.footerText}>Total Entitled: {leaveData.totalEntitled}</Text>
      <Text style={styles.footerText}>Total Taken: {leaveData.totalTaken}</Text>
      <Text style={[styles.footerText, { color: leaveData.balance < 0 ? 'red' : 'green' }]}>
        Final Balance: {leaveData.balance}
      </Text>
    </View>
  );
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Leave Balance Summary</Text>
      <FlatList
        data={leaveData.summary}
